...
public class Student {
	...
	public void setStudentData(
			int num,String name,int kor,int eng,int math) {
		this.num=num;
		this.name=name;
		this.kor=kor;
		this.eng=eng;
	 ...
	 */
	public void print() {
		System.out.printf("%3d %4s %4d %4d %4d %4d %4.1f %3c %4d%n",this.num,this.name,this.kor,this.eng,this.math,this.total,this.avg,this.grade,this.rank );
	}
