...
public class StaticMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("static 1객체의 주소값:"+ static1);
		...
		System.out.println("static 2객체의 주소값:"+ static2);
		static2.instance_field=2222;
		System.out.println("static2.instance_field"+static2.instance_field);
		static2.instance_method();
		System.out.println();
		System.out.println("---객체 주소를 통해서 static member access---");
		
//<비추>	System.out.println(static1.static_field);
